...
.pull-right-2[
<br>
```{r MTH208, echo=FALSE, fig.align='center', fig.width=5, fig.cap="MTH 208 Exploratory Data Analysis in Spring 2024."}
include_graphics("./figs/MTH208.jpg")
```


```{r capstone, echo=FALSE, fig.align='center', fig.width=5, fig.cap="Students for Capstone Projects in Spring 2023."}
...
```{r research, echo=FALSE, fig.align='center', fig.width=7}
...
```{r cook, echo=FALSE, fig.align='center', out.width="80%", fig.cap="My first homemade curry rice!"}
include_graphics("./figs/cook.jpg")
```

**Lazy people must know a way to survive!** `r emo::ji("smile")`

```{r USA_Life, echo=FALSE, fig.align='center', out.width="80%", fig.cap="My wonderful neighbor, Jo, with her brother and sister-in-law."}
...
.pull-right-2[
```{r taiwanese2, echo=FALSE, fig.align='center', out.width="80%", fig.cap="2011, Taiwanese Student Party."}
include_graphics("./figs/BGSU_taiwanese2.jpg")
```

<br>
```{r put_in_bay, echo=FALSE, fig.align='center', out.width="80%", fig.cap="2015, Put-in-Bay Trip."}
...
.pull-right-2[
```{r Gupta, echo=FALSE, fig.align='center', out.width="75%", fig.cap="2015, Dr. Arjun K. Gupta retired."}
...
.pull-right-2[
```{r Albert, echo=FALSE, fig.align='center', out.width="75%", fig.cap="2014, Business Analytics Case Competition, First Place Award, BGSU. Advisor: Dr. Jim Albert."}
...
```{r teaching_award, echo=FALSE, fig.align='center', out.width="80%", fig.cap="2014, Outstanding Teaching Assistant Award, BGSU."}
include_graphics("./figs/teaching_award.jpg")
```

<br>

```{r mytable, echo=FALSE, fig.align='center', out.width="80%", fig.cap="2013, My desk at BGSU."}
...
```{r UD, echo=FALSE, fig.align='center', out.width="100%", fig.cap="2023, UD Graduation Banquet."}
include_graphics("./figs/UD.jpg")
```
...
```{r , echo=FALSE, fig.align='center', out.width="100%", fig.cap="2018, Miryam Award, as a member of F3USE - a faculty group that collaborates on teaching, research, and supporting females in STEM, University of Dayton."}
...
```{r miami1, echo=FALSE, fig.align='center', out.width="75%", fig.cap="2017, Some of my colleagues at Miami University."}
...
```{r miami2, echo=FALSE, fig.align='center', out.width="75%", fig.cap="2017, Goodbye Party at Bob Leonard's house."}
...
.pull-right-2[
```{r allpass, echo=FALSE, fig.align='center', out.width="65%", fig.cap="My lots container for math courses."}
...
```{r flower, echo=FALSE, fig.align='center', out.width="80%", fig.cap="Apple tree flowers in my backyard."}
